...
productive. Here are these - most of them are pretty self explanatory.
  ...
  (setq-default
   ...
   custom-file "~/.emacs.custom/custom-file.el"                    ;; Name of the custom file
...
Have setup this for use with vertico. Vertico is the new completion framework that I am trying after using helm and ivy for
many years. So far it looks pretty promising. Let's see how this goes. Most of this configuration is stolen from the web.
